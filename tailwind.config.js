		...
		extend: {
			colors: {
				...
				background: {
					...
					light: "#FBFBFB",
					dark: "#181719",
					"app-white": "rgb(var(--color-background-app-white)/<alpha-value>)",
					"app-light-blue":
						"rgb(var(--color-background-app-light-blue)/<alpha-value>)",
					"app-blue": "rgb(var(--color-background-app-blue)/<alpha-value>)",
					"app-deep-blue":
						"rgb(var(--color-background-app-deep-blue)/<alpha-value>)",
				},
				indicator: {
